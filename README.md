...
| Benchmark | Public source-free registry: 18 official development families, 125 positive/adversarial cases, 10 manufacturer labels, and 14 component categories; owner-authorized, explicitly agent-attributed audits accepted all 125 cases after correcting rejected crops, while independent review and family-isolated calibration/evaluation splits remain open |
...
| Visual comparators / benchmark corpus | Text-layout, RapidOCR, and pinned OpenCLIP comparators exist; all 18 families have agent-audited labels but remain development data, and none are held-out accuracy evidence |
