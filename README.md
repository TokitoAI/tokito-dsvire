...
| Benchmark | Public source-free registry: 20 official development families, 139 positive/adversarial cases, 11 manufacturer labels, and 16 component categories; owner-authorized, explicitly agent-attributed audits accepted all 139 cases after correcting rejected crops, while independent review and family-isolated calibration/evaluation splits remain open |
...
| Visual comparators / benchmark corpus | Text-layout, RapidOCR, and pinned OpenCLIP comparators exist; all 20 families have agent-audited labels but remain development data, and none are held-out accuracy evidence |
