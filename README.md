...
| Benchmark | Public source-free registry: 30 official development families, 209 positive/adversarial cases, 14 manufacturer labels, and 26 component categories; owner-authorized, explicitly agent-attributed audits accepted all 209 cases after correcting rejected crops, while independent review and family-isolated calibration/evaluation splits remain open |
...
| Visual comparators / benchmark corpus | Text-layout, RapidOCR, and pinned OpenCLIP comparators exist; all 30 families have agent-audited labels but remain development data, and none are held-out accuracy evidence |
