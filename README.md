...
| Benchmark | Public source-free registry: 25 official development families, 174 positive/adversarial cases, 11 manufacturer labels, and 21 component categories; owner-authorized, explicitly agent-attributed audits accepted all 174 cases after correcting rejected crops, while independent review and family-isolated calibration/evaluation splits remain open |
...
| Visual comparators / benchmark corpus | Text-layout, RapidOCR, and pinned OpenCLIP comparators exist; all 25 families have agent-audited labels but remain development data, and none are held-out accuracy evidence |
