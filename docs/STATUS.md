...
Cycle v4 is retired: the official MMA8451Q URL is unavailable and that family
was invalidated without replacement. Do not author cycle v4. Cycle v5 is the
live 12-family visual-gate plan (accelerometer: NXP FXLS8974CF). It has exact
sealed sources and a score-free authoring packet. It still requires genuinely
human-authored natural queries and a different independent human reviewer
before calibration or evaluation scores may be accessed. Production training
