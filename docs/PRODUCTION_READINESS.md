...
| DSV-011 | P1 | Open | Production dependencies are range-resolved during image builds; no universal lock or automated vulnerability/license gate currently proves reproducibility. | Universal lock with update workflow, dependency audit, license/SBOM policy, reproducible image digest evidence. |
