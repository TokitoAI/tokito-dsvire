...
|---|---|---|
| `python -m pytest -q` on Windows/Python 3.11 | 108 passed, 1 skipped on the identity-evaluation branch | Unit/fixture/API/evaluator tests; not corpus accuracy or load evidence |
